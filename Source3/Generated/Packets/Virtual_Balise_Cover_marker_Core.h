...
inline int encode(PacketInfo& data, kcg_int* stream, const Virtual_Balise_Cover_marker_Core& p)
{
    return Virtual_Balise_Cover_marker_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Virtual_Balise_Cover_marker_Core& p)
{
