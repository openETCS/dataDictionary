...
inline int encode(PacketInfo& data, kcg_int* stream, const Danger_for_Shunting_information_Core& p)
{
    return Danger_for_Shunting_information_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Danger_for_Shunting_information_Core& p)
{
