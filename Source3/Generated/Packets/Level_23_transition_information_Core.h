...
int Level_23_transition_information_Encode_Int(PacketInfo* data, kcg_int* stream, const Level_23_transition_information_Core* p);

int Level_23_transition_information_Decode_Int(PacketInfo* data, const kcg_int* stream, Level_23_transition_information_Core* p);
...
inline int encode(Bitstream& stream, const Level_23_transition_information_Core& p)
{
    return Level_23_transition_information_Encode_Bit(&stream, &p);
}
...
inline int encode(PacketInfo& data, kcg_int* stream, const Level_23_transition_information_Core& p)
{
    return Level_23_transition_information_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Level_23_transition_information_Core& p)
{
