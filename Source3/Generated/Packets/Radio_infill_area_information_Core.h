...
int Radio_infill_area_information_Encode_Int(PacketInfo* data, kcg_int* stream, const Radio_infill_area_information_Core* p);

int Radio_infill_area_information_Decode_Int(PacketInfo* data, const kcg_int* stream, Radio_infill_area_information_Core* p);
...
inline int encode(PacketInfo& data, kcg_int* stream, const Radio_infill_area_information_Core& p)
{
    return Radio_infill_area_information_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Radio_infill_area_information_Core& p)
{
