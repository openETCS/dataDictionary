...
inline int encode(PacketInfo& data, kcg_int* stream, const Level_Crossing_information_Core& p)
{
    return Level_Crossing_information_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Level_Crossing_information_Core& p)
{
