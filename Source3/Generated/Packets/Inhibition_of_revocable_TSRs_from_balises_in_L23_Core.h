...
int Inhibition_of_revocable_TSRs_from_balises_in_L23_Encode_Int(PacketInfo* data, kcg_int* stream, const Inhibition_of_revocable_TSRs_from_balises_in_L23_Core* p);

int Inhibition_of_revocable_TSRs_from_balises_in_L23_Decode_Int(PacketInfo* data, const kcg_int* stream, Inhibition_of_revocable_TSRs_from_balises_in_L23_Core* p);
...
inline int encode(PacketInfo& data, kcg_int* stream, const Inhibition_of_revocable_TSRs_from_balises_in_L23_Core& p)
{
    return Inhibition_of_revocable_TSRs_from_balises_in_L23_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Inhibition_of_revocable_TSRs_from_balises_in_L23_Core& p)
{
