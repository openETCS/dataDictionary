...
// ================
    ...
    const unsigned int a_Bit_Laeng_Level_23_transition_information[] = { 8, 13, 24 }; 
...
// ================
    ...
    const unsigned int a_Bit_Laeng_Position_Report_based_on_two_balise_groups[] = { 8, 13, 2, 24, 24, 15, 2, 2, 15, 15, 2, 15, 7, 2, 4, 3, 8 }; 
    const unsigned int a_Start_Bit_Position_Report_based_on_two_balise_groups[] = { 0, 8, 21, 23, 47, 71, 86, 88, 90, 105, 120, 122, 137, 144, 146, 150, 153 };
// ================
...
// ================
    ...
    const char         a_Var_Namen_Data_used_by_applications_outside_the_ERTMSETCS_system[] = { "NID_PACKET", "Q_DIR", "L_PACKET", "NID_XUSER", "NID_NTC", "Other_data_depending_on_NID_XUSER" };
...
// ================
    ...
    const unsigned int a_Bit_Laeng_Position_Report[] = { 8, 13, 2, 24, 15, 2, 2, 15, 15, 2, 15, 7, 2, 4, 3, 8 }; 
    const unsigned int a_Start_Bit_Position_Report[] = { 0, 8, 21, 23, 47, 62, 64, 66, 81, 96, 98, 113, 120, 122, 126, 129 };
// ================
