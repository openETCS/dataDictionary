...
// Packet Number = 72
	...
	T_q_scale              Q_SCALE               ;		// # 2	
	T_q_textclass          Q_TEXTCLASS           ;		// # 2	
	T_q_textdisplay        Q_TEXTDISPLAY         ;		// # 1		// Start/end events relation
	...
	T_q_textconfirm        Q_TEXTCONFIRM         ;		// # 2		// if (Q_TEXTCONFIRM != 0)
	T_q_conftextdisplay    Q_CONFTEXTDISPLAY     ;		// # 1		// If Q_TEXTCONFIRM != 0
	T_q_textreport         Q_TEXTREPORT          ;		// # 1		// If Q_TEXTCONFIRM != 0	// if (Q_TEXTREPORT == 1)
