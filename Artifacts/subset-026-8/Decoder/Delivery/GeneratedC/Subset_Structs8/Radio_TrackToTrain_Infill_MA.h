#ifndef NESTINGMARK_oETCS_Packet_Radio_TrackToTrain_Infill_MA
#define NESTINGMARK_oETCS_Packet_Radio_TrackToTrain_Infill_MA
/* =============================================================================
Formalization of Subset-026-8 (Chapter 8: ERTMS/ETCS language)

- Name: Subset-026-8 / Radio_TrackToTrain_Infill_MA
...
struct DATA_oETCS_Radio_TrackToTrain_Infill_MA {
...
// struct -> type
typedef struct DATA_oETCS_Radio_TrackToTrain_Infill_MA T_DATA_oETCS_Radio_TrackToTrain_Infill_MA;
// typ -> ptrtyp
typedef  T_DATA_oETCS_Radio_TrackToTrain_Infill_MA* TP_DATA_oETCS_Radio_TrackToTrain_Infill_MA;
// declaration of variable of ptrtyp
extern TP_DATA_oETCS_Radio_TrackToTrain_Infill_MA  oETCS_Packet_Radio_TrackToTrain_Infill_MA;
// instatiate this ptrtype variable like this: (get memory and fill memory)
// TP_DATA_oETCS_Radio_TrackToTrain_Infill_MA  oETCS_Packet_Radio_TrackToTrain_Infill_MA = new(T_DATA_oETCS_Radio_TrackToTrain_Infill_MA);
// and now fill in the content to start with ...
// Access variable like this: oETCS_Packet_Radio_TrackToTrain_Infill_MA->...
// maybe : memset(oETCS_Packet_Radio_TrackToTrain_Infill_MA, 0, sizeof(T_DATA_oETCS_Packet_Radio_TrackToTrain_Infill_MA));
