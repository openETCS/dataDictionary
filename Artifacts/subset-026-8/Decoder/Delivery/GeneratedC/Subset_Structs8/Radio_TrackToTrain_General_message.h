#ifndef NESTINGMARK_Radio_Message_TrackToTrain_General_message
#define NESTINGMARK_Radio_Message_TrackToTrain_General_message
/* =============================================================================
Formalization of Subset-026-8 (Chapter 8: ERTMS/ETCS language)

- Name: Subset-026-7 / TrackToTrain_General_message
...
struct DATA_Radio_TrackToTrain_General_message {
...
// struct -> type
typedef struct DATA_Radio_TrackToTrain_General_message T_DATA_Radio_TrackToTrain_General_message;
// typ -> ptrtyp
typedef  T_DATA_Radio_TrackToTrain_General_message* TP_DATA_Radio_TrackToTrain_General_message;
// declaration of variable of ptrtyp
extern TP_DATA_Radio_TrackToTrain_General_message  Radio_Packet_TrackToTrain_General_message;
// instatiate this ptrtype variable like this: (get memory and fill memory)
// TP_DATA_Radio_TrackToTrain_General_message  Radio_Packet_TrackToTrain_General_message = new(T_DATA_Radio_TrackToTrain_General_message);
// and now fill in the content to start with ...
// Access variable like this: Radio_Packet_TrackToTrain_General_message->...
// maybe : memset(Radio_Packet_TrackToTrain_General_message, 0, sizeof(T_DATA_Radio_Packet_TrackToTrain_General_message));
