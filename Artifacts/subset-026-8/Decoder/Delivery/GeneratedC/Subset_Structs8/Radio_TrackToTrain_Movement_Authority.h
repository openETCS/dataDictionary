#ifndef NESTINGMARK_oETCS_Packet_Radio_TrackToTrain_Movement_Authority
#define NESTINGMARK_oETCS_Packet_Radio_TrackToTrain_Movement_Authority
/* =============================================================================
Formalization of Subset-026-8 (Chapter 8: ERTMS/ETCS language)

- Name: Subset-026-8 / Radio_TrackToTrain_Movement_Authority
...
struct DATA_oETCS_Radio_TrackToTrain_Movement_Authority {
...
// struct -> type
typedef struct DATA_oETCS_Radio_TrackToTrain_Movement_Authority T_DATA_oETCS_Radio_TrackToTrain_Movement_Authority;
// typ -> ptrtyp
typedef  T_DATA_oETCS_Radio_TrackToTrain_Movement_Authority* TP_DATA_oETCS_Radio_TrackToTrain_Movement_Authority;
// declaration of variable of ptrtyp
extern TP_DATA_oETCS_Radio_TrackToTrain_Movement_Authority  oETCS_Packet_Radio_TrackToTrain_Movement_Authority;
// instatiate this ptrtype variable like this: (get memory and fill memory)
// TP_DATA_oETCS_Radio_TrackToTrain_Movement_Authority  oETCS_Packet_Radio_TrackToTrain_Movement_Authority = new(T_DATA_oETCS_Radio_TrackToTrain_Movement_Authority);
// and now fill in the content to start with ...
// Access variable like this: oETCS_Packet_Radio_TrackToTrain_Movement_Authority->...
// maybe : memset(oETCS_Packet_Radio_TrackToTrain_Movement_Authority, 0, sizeof(T_DATA_oETCS_Packet_Radio_TrackToTrain_Movement_Authority));
