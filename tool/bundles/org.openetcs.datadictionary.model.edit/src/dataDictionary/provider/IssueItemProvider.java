...
/**
 * This is the item provider adapter for a {@link dataDictionary.Issue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Issue_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Issue_name_feature", "_UI_Issue_type"),
				 DataDictionaryPackage.Literals.ISSUE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataDictionaryPackage.Literals.ISSUE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addClosedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Issue_closed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Issue_closed_feature", "_UI_Issue_type"),
				 DataDictionaryPackage.Literals.ISSUE__CLOSED,
				 true,
				 false,
				 false,
