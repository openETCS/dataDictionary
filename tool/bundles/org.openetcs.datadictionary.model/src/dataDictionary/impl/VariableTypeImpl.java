 ...
 * <ul>
 *   <li>{@link dataDictionary.impl.VariableTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableTypeImpl extends MinimalEObjectImpl.Container implements VariableType {
	...
	protected EClass eStaticClass() {
		return DataDictionaryPackage.Literals.VARIABLE_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataDictionaryPackage.VARIABLE_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataDictionaryPackage.VARIABLE_TYPE__NAME:
				return getName();
		}
