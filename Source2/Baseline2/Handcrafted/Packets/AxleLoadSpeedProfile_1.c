...
{
    void* raw = malloc(sizeof(AxleLoadSpeedProfile_1));
    AxleLoadSpeedProfile_1* ptr = (AxleLoadSpeedProfile_1*)raw;
    AxleLoadSpeedProfile_1_Init(ptr);
    return ptr;
}


void AxleLoadSpeedProfile_1_Delete(AxleLoadSpeedProfile_1* ptr)
{
    free(ptr);
}
...
{
    if (Bitstream_Normal(stream, AXLELOADSPEEDPROFILE_1_BITSIZE))
    {
        if (AxleLoadSpeedProfile_1_UpperBitsNotSet(p))
        {
...
int AxleLoadSpeedProfile_1_EncodeInt(const AxleLoadSpeedProfile_1* p, kcg_int* startAddress, kcg_int* stream)
{
...
int AxleLoadSpeedProfile_1_DecodeInt(AxleLoadSpeedProfile_1* p, kcg_int* startAddress, const kcg_int* stream)
{
