...
- Name: Subset-026-7 / Packet_DecodeBit
    ...
    switch (header->list)
    {
        case TRAINTOTRACK :
        {
            switch (header->NID_PACKET)
            {
                ...
                default :
                {
                    fprintf(stderr, "Packet_DecodeBit: unexpected value for header->NID_PACKET = %lu\n", header->NID_PACKET);
                    return 0;
                }
            };
        }
        ...
        default:
        {
            fprintf(stderr, "Packet_DecodeBit: unexpected value for header->list = %lu\n", header->list);
            return 0;
        }
    };
}
