...
int Track_Condition_Change_of_traction_system_Encode_Int(PacketInfo* data, kcg_int* stream, const Track_Condition_Change_of_traction_system_Core* p);

int Track_Condition_Change_of_traction_system_Decode_Int(PacketInfo* data, const kcg_int* stream, Track_Condition_Change_of_traction_system_Core* p);
...
inline int encode(PacketInfo& data, kcg_int* stream, const Track_Condition_Change_of_traction_system_Core& p)
{
    return Track_Condition_Change_of_traction_system_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Track_Condition_Change_of_traction_system_Core& p)
{
