...
int List_of_Balises_in_SR_Authority_Core_1_Encode_Int(Packet_Info* data, kcg_int* stream, const List_of_Balises_in_SR_Authority_Core_1* p);

int List_of_Balises_in_SR_Authority_Core_1_Decode_Int(Packet_Info* data, const kcg_int* stream, List_of_Balises_in_SR_Authority_Core_1* p);
...
{
    return List_of_Balises_in_SR_Authority_Core_1_Encode_Bit(&stream, &p);
}

inline int decode(Bitstream& stream, List_of_Balises_in_SR_Authority_Core_1& p)
{
    return List_of_Balises_in_SR_Authority_Core_1_Decode_Bit(&stream, &p);
}

inline int encode(Packet_Info& data, kcg_int* stream, const List_of_Balises_in_SR_Authority_Core_1& p)
{
    std::cerr << "encode int function not implemented for packet 63 yet." << std::endl;

    return List_of_Balises_in_SR_Authority_Core_1_Encode_Int(&data, stream, &p);
}

inline int decode(Packet_Info& data, const kcg_int* stream, List_of_Balises_in_SR_Authority_Core_1& p)
{
    std::cerr << "decode int function not implemented for packet 63 yet." << std::endl;

    return List_of_Balises_in_SR_Authority_Core_1_Decode_Int(&data, stream, &p);
}
