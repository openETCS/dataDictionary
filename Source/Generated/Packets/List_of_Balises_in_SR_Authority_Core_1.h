...
inline int encode(PacketInfo& data, kcg_int* stream, const List_of_Balises_in_SR_Authority_Core_1& p)
{
...
inline int decode(PacketInfo& data, const kcg_int* stream, List_of_Balises_in_SR_Authority_Core_1& p)
{
