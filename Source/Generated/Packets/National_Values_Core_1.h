...
inline int encode(Packet_Info& data, kcg_int* stream, kcg_int startAddress, const National_Values_Core_1& p)
{
    return National_Values_Core_1_Encode_Int(&data, stream, startAddress, &p);
}

inline int decode(const Packet_Info& data, const kcg_int* stream, National_Values_Core_1& p)
{
