...
int Track_Condition_Station_Platforms_Core_1_Encode_Int(Packet_Info* data, kcg_int* stream, const Track_Condition_Station_Platforms_Core_1* p);

int Track_Condition_Station_Platforms_Core_1_Decode_Int(Packet_Info* data, const kcg_int* stream, Track_Condition_Station_Platforms_Core_1* p);
...
{
    return Track_Condition_Station_Platforms_Core_1_Encode_Bit(&stream, &p);
}

inline int decode(Bitstream& stream, Track_Condition_Station_Platforms_Core_1& p)
{
    return Track_Condition_Station_Platforms_Core_1_Decode_Bit(&stream, &p);
}

inline int encode(Packet_Info& data, kcg_int* stream, const Track_Condition_Station_Platforms_Core_1& p)
{
    std::cerr << "encode int function not implemented for packet 69 yet." << std::endl;

    return Track_Condition_Station_Platforms_Core_1_Encode_Int(&data, stream, &p);
}

inline int decode(Packet_Info& data, const kcg_int* stream, Track_Condition_Station_Platforms_Core_1& p)
{
    std::cerr << "decode int function not implemented for packet 69 yet." << std::endl;

    return Track_Condition_Station_Platforms_Core_1_Decode_Int(&data, stream, &p);
}
