...
int Track_Condition_Big_Metal_Masses_Core_1_Encode_Int(PacketInfo* data, kcg_int* stream, const Track_Condition_Big_Metal_Masses_Core_1* p);

int Track_Condition_Big_Metal_Masses_Core_1_Decode_Int(PacketInfo* data, const kcg_int* stream, Track_Condition_Big_Metal_Masses_Core_1* p);
...
inline int encode(PacketInfo& data, kcg_int* stream, const Track_Condition_Big_Metal_Masses_Core_1& p)
{
    std::cerr << "encode int function not implemented for packet 67 yet." << std::endl;

    return Track_Condition_Big_Metal_Masses_Core_1_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Track_Condition_Big_Metal_Masses_Core_1& p)
{
