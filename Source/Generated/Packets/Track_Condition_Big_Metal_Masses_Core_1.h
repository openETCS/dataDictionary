...
inline int encode(Packet_Info& data, kcg_int* stream, const Track_Condition_Big_Metal_Masses_Core_1& p)
{
...
inline int decode(Packet_Info& data, const kcg_int* stream, Track_Condition_Big_Metal_Masses_Core_1& p)
{
