...
int EOLM_Packet_Encode_Int(PacketInfo* data, kcg_int* stream, const EOLM_Packet_Core* p);

int EOLM_Packet_Decode_Int(PacketInfo* data, const kcg_int* stream, EOLM_Packet_Core* p);
...
inline int encode(PacketInfo& data, kcg_int* stream, const EOLM_Packet_Core& p)
{
    return EOLM_Packet_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, EOLM_Packet_Core& p)
{
