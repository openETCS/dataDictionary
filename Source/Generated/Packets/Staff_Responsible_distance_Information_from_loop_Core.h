...
int Staff_Responsible_distance_Information_from_loop_Encode_Int(Packet_Info* data, kcg_int* stream, const Staff_Responsible_distance_Information_from_loop_Core* p);

int Staff_Responsible_distance_Information_from_loop_Decode_Int(Packet_Info* data, const kcg_int* stream, Staff_Responsible_distance_Information_from_loop_Core* p);
...
inline int encode(Packet_Info& data, kcg_int* stream, const Staff_Responsible_distance_Information_from_loop_Core& p)
{
    std::cerr << "encode int function not implemented for packet 13 yet." << std::endl;

    return Staff_Responsible_distance_Information_from_loop_Encode_Int(&data, stream, &p);
}

inline int decode(Packet_Info& data, const kcg_int* stream, Staff_Responsible_distance_Information_from_loop_Core& p)
{
