...
inline int encode(Packet_Info& data, kcg_int* stream, const Error_Reporting_Core& p)
{
    return Error_Reporting_Encode_Int(&data, stream, &p);
}

inline int decode(Packet_Info& data, const kcg_int* stream, Error_Reporting_Core& p)
{
