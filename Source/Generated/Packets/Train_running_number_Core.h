...
inline int encode(PacketInfo& data, kcg_int* stream, const Train_running_number_Core& p)
{
    return Train_running_number_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Train_running_number_Core& p)
{
