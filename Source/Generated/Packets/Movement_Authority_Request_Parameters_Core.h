...
inline int encode(PacketInfo& data, kcg_int* stream, const Movement_Authority_Request_Parameters_Core& p)
{
    return Movement_Authority_Request_Parameters_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Movement_Authority_Request_Parameters_Core& p)
{
