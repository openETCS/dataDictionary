...
inline int encode(Packet_Info& data, kcg_int* stream, const Axle_Load_Speed_Profile_Core_2& p)
{
    std::cerr << "encode int function not implemented for packet 51 yet." << std::endl;

    return Axle_Load_Speed_Profile_Core_2_Encode_Int(&data, stream, &p);
}

inline int decode(Packet_Info& data, const kcg_int* stream, Axle_Load_Speed_Profile_Core_2& p)
{
