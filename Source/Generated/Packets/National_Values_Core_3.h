...
inline int encode(PacketInfo& data, kcg_int* stream, const National_Values_Core_3& p)
{
...
inline int decode(PacketInfo& data, const kcg_int* stream, National_Values_Core_3& p)
{
