...
inline int encode(Packet_Info& data, kcg_int* stream, const National_Values_Core_4& p)
{
    std::cerr << "encode int function not implemented for packet 3 yet." << std::endl;

    return National_Values_Core_4_Encode_Int(&data, stream, &p);
}

inline int decode(Packet_Info& data, const kcg_int* stream, National_Values_Core_4& p)
{
