...
inline int encode(PacketInfo& data, kcg_int* stream, const Level_23_Movement_Authority_Core& p)
{
...
inline int decode(PacketInfo& data, const kcg_int* stream, Level_23_Movement_Authority_Core& p)
{
