...
inline int encode(Packet_Info& data, kcg_int* stream, const Permitted_Braking_Distance_Information_Core& p)
{
...
inline int decode(Packet_Info& data, const kcg_int* stream, Permitted_Braking_Distance_Information_Core& p)
{
