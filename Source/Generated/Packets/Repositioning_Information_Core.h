...
inline int encode(PacketInfo& data, kcg_int* stream, const Repositioning_Information_Core& p)
{
    return Repositioning_Information_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Repositioning_Information_Core& p)
{
