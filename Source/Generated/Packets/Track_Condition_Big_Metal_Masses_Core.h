...
int Track_Condition_Big_Metal_Masses_Encode_Int(Packet_Info* data, kcg_int* stream, const Track_Condition_Big_Metal_Masses_Core* p);

int Track_Condition_Big_Metal_Masses_Decode_Int(Packet_Info* data, const kcg_int* stream, Track_Condition_Big_Metal_Masses_Core* p);
...
inline int encode(Packet_Info& data, kcg_int* stream, const Track_Condition_Big_Metal_Masses_Core& p)
{
    std::cerr << "encode int function not implemented for packet 67 yet." << std::endl;

    return Track_Condition_Big_Metal_Masses_Encode_Int(&data, stream, &p);
}

inline int decode(Packet_Info& data, const kcg_int* stream, Track_Condition_Big_Metal_Masses_Core& p)
{
