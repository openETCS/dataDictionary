...
int Stop_Shunting_on_desk_opening_Encode_Int(PacketInfo* data, kcg_int* stream, const Stop_Shunting_on_desk_opening_Core* p);

int Stop_Shunting_on_desk_opening_Decode_Int(PacketInfo* data, const kcg_int* stream, Stop_Shunting_on_desk_opening_Core* p);
...
inline int encode(PacketInfo& data, kcg_int* stream, const Stop_Shunting_on_desk_opening_Core& p)
{
    return Stop_Shunting_on_desk_opening_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Stop_Shunting_on_desk_opening_Core& p)
{
