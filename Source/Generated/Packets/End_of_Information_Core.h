...
inline int encode(PacketInfo& data, kcg_int* stream, const End_of_Information_Core& p)
{
    return End_of_Information_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, End_of_Information_Core& p)
{
