...
#define DATA_USED_BY_APPLICATIONS_OUTSIDE_THE_ERTMSETCS_SYSTEM_CORE_BITSIZE 86
...
{
    return Data_used_by_applications_outside_the_ERTMSETCS_system_Encode_Bit(&stream, &p);
}

inline int decode(Bitstream& stream, Data_used_by_applications_outside_the_ERTMSETCS_system_Core& p)
{
    return Data_used_by_applications_outside_the_ERTMSETCS_system_Decode_Bit(&stream, &p);
}

inline int encode(PacketInfo& data, kcg_int* stream, const Data_used_by_applications_outside_the_ERTMSETCS_system_Core& p)
{
    return Data_used_by_applications_outside_the_ERTMSETCS_system_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Data_used_by_applications_outside_the_ERTMSETCS_system_Core& p)
{
    return Data_used_by_applications_outside_the_ERTMSETCS_system_Decode_Int(&data, stream, &p);
}
