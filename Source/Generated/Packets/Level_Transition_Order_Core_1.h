...
inline int encode(Packet_Info& data, kcg_int* stream, const Level_Transition_Order_Core_1& p)
{
...
inline int decode(Packet_Info& data, const kcg_int* stream, Level_Transition_Order_Core_1& p)
{
