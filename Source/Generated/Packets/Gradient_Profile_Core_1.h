...
inline int encode(Packet_Info& data, kcg_int* stream, const Gradient_Profile_Core_1& p)
{
...
inline int decode(Packet_Info& data, const kcg_int* stream, Gradient_Profile_Core_1& p)
{
