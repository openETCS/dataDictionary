...
inline int encode(PacketInfo& data, kcg_int* stream, const Track_Condition_Station_Platforms_Core& p)
{
    return Track_Condition_Station_Platforms_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Track_Condition_Station_Platforms_Core& p)
{
