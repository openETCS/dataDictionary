...
inline int encode(Packet_Info& data, kcg_int* stream, const List_of_balises_for_SH_Area_Core& p)
{
...
inline int decode(Packet_Info& data, const kcg_int* stream, List_of_balises_for_SH_Area_Core& p)
{
