...
int National_Values_Encode_Int(Packet_Info* data, kcg_int* stream, const National_Values_Core* p);

int National_Values_Decode_Int(Packet_Info* data, const kcg_int* stream, National_Values_Core* p);
...
inline int encode(Packet_Info& data, kcg_int* stream, const National_Values_Core& p)
{
...
inline int decode(Packet_Info& data, const kcg_int* stream, National_Values_Core& p)
{
