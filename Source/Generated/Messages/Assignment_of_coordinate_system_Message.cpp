...
bool Assignment_of_coordinate_system_Message::decode(Bitstream& stream)
{
    ...
    Q_ORIENTATION = Bitstream_Read(&stream, 1);
...
bool Assignment_of_coordinate_system_Message::encode(Bitstream& stream) const
{
    uint32_t old_pos = stream.bitpos;
    ...
    Bitstream_Write(&stream, 1, Q_ORIENTATION);
