...
BasePacketPtr PacketFactory_TrainToTrack(Bitstream& stream, Packet_Header header)
{
...
BasePacketPtr PacketFactory_TrackToTrain(Bitstream& stream, Packet_Header header)
{
    switch (header.NID_PACKET)
    {
        case 0 :
