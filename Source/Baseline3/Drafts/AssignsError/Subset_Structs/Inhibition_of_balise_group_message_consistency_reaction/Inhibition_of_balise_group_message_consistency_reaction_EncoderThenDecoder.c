...
*/
void Inhibition_of_balise_group_message_consistency_reaction_EncoderThenDecoder(Bitstream* stream, Inhibition_of_balise_group_message_consistency_reaction* p)
{
