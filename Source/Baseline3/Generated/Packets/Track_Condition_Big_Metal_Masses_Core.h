...
int Track_Condition_Big_Metal_Masses_Encode_Int(PacketInfo* data, kcg_int* stream, const Track_Condition_Big_Metal_Masses_Core* p);

int Track_Condition_Big_Metal_Masses_Decode_Int(PacketInfo* data, const kcg_int* stream, Track_Condition_Big_Metal_Masses_Core* p);
...
inline int encode(PacketInfo& data, kcg_int* stream, const Track_Condition_Big_Metal_Masses_Core& p)
{
...
inline int decode(PacketInfo& data, const kcg_int* stream, Track_Condition_Big_Metal_Masses_Core& p)
{
