...
inline int encode(PacketInfo& data, kcg_int* stream, const System_Version_order_Core& p)
{
    return System_Version_order_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, System_Version_order_Core& p)
{
