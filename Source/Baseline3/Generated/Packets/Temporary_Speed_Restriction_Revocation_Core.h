...
inline int encode(PacketInfo& data, kcg_int* stream, const Temporary_Speed_Restriction_Revocation_Core& p)
{
    return Temporary_Speed_Restriction_Revocation_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Temporary_Speed_Restriction_Revocation_Core& p)
{
