...
inline int encode(PacketInfo& data, kcg_int* stream, const Adhesion_Factor_Core& p)
{
    return Adhesion_Factor_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Adhesion_Factor_Core& p)
{
