...
#define MODE_PROFILE_CORE_BITSIZE 76
...
inline int encode(PacketInfo& data, kcg_int* stream, const Mode_profile_Core& p)
{
...
inline int decode(PacketInfo& data, const kcg_int* stream, Mode_profile_Core& p)
{
