...
int Permitted_Braking_Distance_Information_Encode_Int(PacketInfo* data, kcg_int* stream, const Permitted_Braking_Distance_Information_Core* p)
{
    ...
    stream[data->startAddress++] = p->D_PBD;
    stream[data->startAddress++] = p->Q_GDIR;
    stream[data->startAddress++] = p->G_PBDSR;
    stream[data->startAddress++] = p->Q_PBDSR;
    stream[data->startAddress++] = p->D_PBDSR;
    stream[data->startAddress++] = p->L_PBDSR;
    stream[data->startAddress++] = p->N_ITER_1;

    for (uint32_t i = 0; i < p->N_ITER_1; ++i)
    {
        Permitted_Braking_Distance_Information_Core_1_Encode_Int(data, stream, &(p->sub_1[i]));
    }
...
int Permitted_Braking_Distance_Information_Decode_Int(PacketInfo* data, const kcg_int* stream, Permitted_Braking_Distance_Information_Core* p)
{
    ...
    p->D_PBD = stream[data->startAddress++];
    p->Q_GDIR = stream[data->startAddress++];
    p->G_PBDSR = stream[data->startAddress++];
    p->Q_PBDSR = stream[data->startAddress++];
    p->D_PBDSR = stream[data->startAddress++];
    p->L_PBDSR = stream[data->startAddress++];
    p->N_ITER_1 = stream[data->startAddress++];

    for (uint32_t i = 0; i < p->N_ITER_1; ++i)
    {
        Permitted_Braking_Distance_Information_Core_1_Decode_Int(data, stream, &(p->sub_1[i]));
    }
