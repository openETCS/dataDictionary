...
#define LEVEL_23_MOVEMENT_AUTHORITY_CORE_1_CORE_BITSIZE 981
...
/*@
    ...
    predicate EqualBits(Bitstream* stream, integer pos, Level_23_Movement_Authority_Core_1* p) = \true;

    predicate UpperBitsNotSet(Level_23_Movement_Authority_Core_1* p) = \true;
