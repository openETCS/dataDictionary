...
struct International_Static_Speed_Profile_Core_1
{
    ...
    uint64_t   Q_DIFF_n;         // # 2
    uint64_t   NC_CDDIFF_n;      // # 4
    uint64_t   NC_DIFF_n;        // # 4
    uint64_t   V_DIFF_n;         // # 7
};
