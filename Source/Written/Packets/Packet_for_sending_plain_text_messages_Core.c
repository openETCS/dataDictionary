...
int Packet_for_sending_plain_text_messages_Encode_Int(PacketInfo* data, kcg_int* stream, const Packet_for_sending_plain_text_messages_Core* p)
{
    ...
    stream[data->startAddress++] = p->Q_TEXTCLASS;
    stream[data->startAddress++] = p->Q_TEXTDISPLAY;
    stream[data->startAddress++] = p->D_TEXTDISPLAY;
    stream[data->startAddress++] = p->M_MODETEXTDISPLAY_0;
    stream[data->startAddress++] = p->M_LEVELTEXTDISPLAY_0;
    stream[data->startAddress++] = p->NID_NTC_0;
    stream[data->startAddress++] = p->L_TEXTDISPLAY;
    stream[data->startAddress++] = p->T_TEXTDISPLAY;
    stream[data->startAddress++] = p->M_MODETEXTDISPLAY_1;
    stream[data->startAddress++] = p->M_LEVELTEXTDISPLAY_1;
    stream[data->startAddress++] = p->NID_NTC_1;
    stream[data->startAddress++] = p->Q_TEXTCONFIRM;
    stream[data->startAddress++] = p->Q_CONFTEXTDISPLAY;
    stream[data->startAddress++] = p->Q_TEXTREPORT;
    stream[data->startAddress++] = p->NID_TEXTMESSAGE;
    stream[data->startAddress++] = p->NID_C;
    stream[data->startAddress++] = p->NID_RBC;
    stream[data->startAddress++] = p->L_TEXT;
    stream[data->startAddress++] = p->X_TEXT;
...
int Packet_for_sending_plain_text_messages_Decode_Int(PacketInfo* data, const kcg_int* stream, Packet_for_sending_plain_text_messages_Core* p)
{
    ...
    p->Q_TEXTCLASS = stream[data->startAddress++];
    p->Q_TEXTDISPLAY = stream[data->startAddress++];
    p->D_TEXTDISPLAY = stream[data->startAddress++];
    p->M_MODETEXTDISPLAY_0 = stream[data->startAddress++];
    p->M_LEVELTEXTDISPLAY_0 = stream[data->startAddress++];
    p->NID_NTC_0 = stream[data->startAddress++];
    p->L_TEXTDISPLAY = stream[data->startAddress++];
    p->T_TEXTDISPLAY = stream[data->startAddress++];
    p->M_MODETEXTDISPLAY_1 = stream[data->startAddress++];
    p->M_LEVELTEXTDISPLAY_1 = stream[data->startAddress++];
    p->NID_NTC_1 = stream[data->startAddress++];
    p->Q_TEXTCONFIRM = stream[data->startAddress++];
    p->Q_CONFTEXTDISPLAY = stream[data->startAddress++];
    p->Q_TEXTREPORT = stream[data->startAddress++];
    p->NID_TEXTMESSAGE = stream[data->startAddress++];
    p->NID_C = stream[data->startAddress++];
    p->NID_RBC = stream[data->startAddress++];
    p->L_TEXT = stream[data->startAddress++];
    p->X_TEXT = stream[data->startAddress++];
