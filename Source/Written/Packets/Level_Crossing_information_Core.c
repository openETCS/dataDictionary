...
int Level_Crossing_information_Encode_Int(PacketInfo* data, kcg_int* stream, const Level_Crossing_information_Core* p)
{
    ...
    stream[data->startAddress++] = p->NID_LX;
    stream[data->startAddress++] = p->D_LX;
    stream[data->startAddress++] = p->L_LX;
    stream[data->startAddress++] = p->Q_LXSTATUS;
    stream[data->startAddress++] = p->V_LX;
    stream[data->startAddress++] = p->Q_STOPLX;
    stream[data->startAddress++] = p->L_STOPLX;
...
int Level_Crossing_information_Decode_Int(PacketInfo* data, const kcg_int* stream, Level_Crossing_information_Core* p)
{
    ...
    p->NID_LX = stream[data->startAddress++];
    p->D_LX = stream[data->startAddress++];
    p->L_LX = stream[data->startAddress++];
    p->Q_LXSTATUS = stream[data->startAddress++];
    p->V_LX = stream[data->startAddress++];
    p->Q_STOPLX = stream[data->startAddress++];
    p->L_STOPLX = stream[data->startAddress++];
