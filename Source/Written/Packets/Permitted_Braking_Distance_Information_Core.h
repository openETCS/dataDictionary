...
int Permitted_Braking_Distance_Information_Encode_Int(PacketInfo* data, kcg_int* stream, const Permitted_Braking_Distance_Information_Core* p);

int Permitted_Braking_Distance_Information_Decode_Int(PacketInfo* data, const kcg_int* stream, Permitted_Braking_Distance_Information_Core* p);
...
inline int encode(Bitstream& stream, const Permitted_Braking_Distance_Information_Core& p)
{
    return Permitted_Braking_Distance_Information_Encode_Bit(&stream, &p);
}

inline int decode(Bitstream& stream, Permitted_Braking_Distance_Information_Core& p)
{
    return Permitted_Braking_Distance_Information_Decode_Bit(&stream, &p);
}

inline int encode(PacketInfo& data, kcg_int* stream, const Permitted_Braking_Distance_Information_Core& p)
{
    return Permitted_Braking_Distance_Information_Encode_Int(&data, stream, &p);
}

inline int decode(PacketInfo& data, const kcg_int* stream, Permitted_Braking_Distance_Information_Core& p)
{
    return Permitted_Braking_Distance_Information_Decode_Int(&data, stream, &p);
}
