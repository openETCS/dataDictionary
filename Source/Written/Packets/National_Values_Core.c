...
int National_Values_Encode_Int(PacketInfo* data, kcg_int* stream, const National_Values_Core* p)
{
    ...
    stream[data->startAddress++] = p->D_VALIDNV;
    stream[data->startAddress++] = p->NID_C;
    stream[data->startAddress++] = p->N_ITER_1;

    for (uint32_t i = 0; i < p->N_ITER_1; ++i)
    {
        National_Values_Core_1_Encode_Int(data, stream, &(p->sub_1[i]));
    }

    stream[data->startAddress++] = p->V_NVSHUNT;
    stream[data->startAddress++] = p->V_NVSTFF;
    stream[data->startAddress++] = p->V_NVONSIGHT;
    stream[data->startAddress++] = p->V_NVLIMSUPERV;
    stream[data->startAddress++] = p->V_NVUNFIT;
    stream[data->startAddress++] = p->V_NVREL;
    stream[data->startAddress++] = p->D_NVROLL;
    stream[data->startAddress++] = p->Q_NVSBTSMPERM;
    stream[data->startAddress++] = p->Q_NVEMRRLS;
    stream[data->startAddress++] = p->Q_NVGUIPERM;
    stream[data->startAddress++] = p->Q_NVSBFBPERM;
    stream[data->startAddress++] = p->Q_NVINHSMICPERM;
    stream[data->startAddress++] = p->V_NVALLOWOVTRP;
    stream[data->startAddress++] = p->V_NVSUPOVTRP;
    stream[data->startAddress++] = p->D_NVOVTRP;
    stream[data->startAddress++] = p->T_NVOVTRP;
    stream[data->startAddress++] = p->D_NVPOTRP;
    stream[data->startAddress++] = p->M_NVCONTACT;
    stream[data->startAddress++] = p->T_NVCONTACT;
    stream[data->startAddress++] = p->M_NVDERUN;
    stream[data->startAddress++] = p->D_NVSTFF;
    stream[data->startAddress++] = p->Q_NVDRIVER_ADHES;
    stream[data->startAddress++] = p->A_NVMAXREDADH1;
    stream[data->startAddress++] = p->A_NVMAXREDADH2;
    stream[data->startAddress++] = p->A_NVMAXREDADH3;
    stream[data->startAddress++] = p->Q_NVLOCACC;
    stream[data->startAddress++] = p->M_NVAVADH;
    stream[data->startAddress++] = p->M_NVEBCL;
    stream[data->startAddress++] = p->Q_NVKINT;
    ...
    for (uint32_t i = 0; i < p->N_ITER_2; ++i)
    {
        National_Values_Core_2_Encode_Int(data, stream, &(p->sub_2[i]));
    }
    ...
    stream[data->startAddress++] = p->L_NVKRINT;
    stream[data->startAddress++] = p->M_NVKRINT;
    stream[data->startAddress++] = p->N_ITER_4;

    for (uint32_t i = 0; i < p->N_ITER_4; ++i)
    {
        National_Values_Core_4_Encode_Int(data, stream, &(p->sub_4[i]));
    }

    stream[data->startAddress++] = p->M_NVKTINT;
...
int National_Values_Decode_Int(PacketInfo* data, const kcg_int* stream, National_Values_Core* p)
{
    ...
    p->D_VALIDNV = stream[data->startAddress++];
    p->NID_C = stream[data->startAddress++];
    p->N_ITER_1 = stream[data->startAddress++];

    for (uint32_t i = 0; i < p->N_ITER_1; ++i)
    {
        National_Values_Core_1_Decode_Int(data, stream, &(p->sub_1[i]));
    }

    p->V_NVSHUNT = stream[data->startAddress++];
    p->V_NVSTFF = stream[data->startAddress++];
    p->V_NVONSIGHT = stream[data->startAddress++];
    p->V_NVLIMSUPERV = stream[data->startAddress++];
    p->V_NVUNFIT = stream[data->startAddress++];
    p->V_NVREL = stream[data->startAddress++];
    p->D_NVROLL = stream[data->startAddress++];
    p->Q_NVSBTSMPERM = stream[data->startAddress++];
    p->Q_NVEMRRLS = stream[data->startAddress++];
    p->Q_NVGUIPERM = stream[data->startAddress++];
    p->Q_NVSBFBPERM = stream[data->startAddress++];
    p->Q_NVINHSMICPERM = stream[data->startAddress++];
    p->V_NVALLOWOVTRP = stream[data->startAddress++];
    p->V_NVSUPOVTRP = stream[data->startAddress++];
    p->D_NVOVTRP = stream[data->startAddress++];
    p->T_NVOVTRP = stream[data->startAddress++];
    p->D_NVPOTRP = stream[data->startAddress++];
    p->M_NVCONTACT = stream[data->startAddress++];
    p->T_NVCONTACT = stream[data->startAddress++];
    p->M_NVDERUN = stream[data->startAddress++];
    p->D_NVSTFF = stream[data->startAddress++];
    p->Q_NVDRIVER_ADHES = stream[data->startAddress++];
    p->A_NVMAXREDADH1 = stream[data->startAddress++];
    p->A_NVMAXREDADH2 = stream[data->startAddress++];
    p->A_NVMAXREDADH3 = stream[data->startAddress++];
    p->Q_NVLOCACC = stream[data->startAddress++];
    p->M_NVAVADH = stream[data->startAddress++];
    p->M_NVEBCL = stream[data->startAddress++];
    p->Q_NVKINT = stream[data->startAddress++];
    ...
    for (uint32_t i = 0; i < p->N_ITER_2; ++i)
    {
        National_Values_Core_2_Decode_Int(data, stream, &(p->sub_2[i]));
    }
    ...
    p->L_NVKRINT = stream[data->startAddress++];
    p->M_NVKRINT = stream[data->startAddress++];
    p->N_ITER_4 = stream[data->startAddress++];

    for (uint32_t i = 0; i < p->N_ITER_4; ++i)
    {
        National_Values_Core_4_Decode_Int(data, stream, &(p->sub_4[i]));
    }

    p->M_NVKTINT = stream[data->startAddress++];
