...
#ifndef REVERSING_SUPERVISION_INFORMATION_DECODER_H_INCLUDED
#define REVERSING_SUPERVISION_INFORMATION_DECODER_H_INCLUDED
...
#endif // REVERSING_SUPERVISION_INFORMATION_DECODER_H_INCLUDED
