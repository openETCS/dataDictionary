...
#include "Track_Condition_Change_of_allowed_current_consumption_Data_Encoder.h"
...
int Track_Condition_Change_of_allowed_current_consumption_Data_Encoder(Bitstream* stream, const Track_Condition_Change_of_allowed_current_consumption_Data* p)
{
    ...
    {
        if (Track_Condition_Change_of_allowed_current_consumption_Data_UpperBitsNotSet(p))
        {
