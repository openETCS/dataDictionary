...
#ifndef VIRTUAL_BALISE_COVER_ORDER_DECODER_H_INCLUDED
#define VIRTUAL_BALISE_COVER_ORDER_DECODER_H_INCLUDED
...
#endif // VIRTUAL_BALISE_COVER_ORDER_DECODER_H_INCLUDED
