...
#ifndef MOVEMENT_AUTHORITY_REQUEST_PARAMETERS_DECODER_H_INCLUDED
#define MOVEMENT_AUTHORITY_REQUEST_PARAMETERS_DECODER_H_INCLUDED
...
#endif // MOVEMENT_AUTHORITY_REQUEST_PARAMETERS_DECODER_H_INCLUDED
