...
#include "Movement_Authority_Request_Parameters_Data_Encoder.h"
#include "Movement_Authority_Request_Parameters_Data_UpperBitsNotSet.h"
#include "Bitwalker_Poke_Normal.h"

int Movement_Authority_Request_Parameters_Data_Encoder(Bitstream* stream, const Movement_Authority_Request_Parameters_Data* p)
{
    if (NormalBitstream(stream, MOVEMENT_AUTHORITY_REQUEST_PARAMETERS_DATA_BITSIZE))
    {
        if (Movement_Authority_Request_Parameters_Data_UpperBitsNotSet(p))
        {
            ...
            stream->bitpos += MOVEMENT_AUTHORITY_REQUEST_PARAMETERS_DATA_BITSIZE;
