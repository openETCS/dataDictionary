...
#ifndef LEVEL_CROSSING_INFORMATION_DECODER_H_INCLUDED
#define LEVEL_CROSSING_INFORMATION_DECODER_H_INCLUDED
...
#endif // LEVEL_CROSSING_INFORMATION_DECODER_H_INCLUDED
