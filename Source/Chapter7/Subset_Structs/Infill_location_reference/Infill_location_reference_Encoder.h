...
#ifndef INFILL_LOCATION_REFERENCE_ENCODER_H_INCLUDED
#define INFILL_LOCATION_REFERENCE_ENCODER_H_INCLUDED
...
#endif // INFILL_LOCATION_REFERENCE_ENCODER_H_INCLUDED
