...
#ifndef TRAIN_RUNNING_NUMBER_FROM_RBC_ENCODER_H_INCLUDED
#define TRAIN_RUNNING_NUMBER_FROM_RBC_ENCODER_H_INCLUDED
...
#endif // TRAIN_RUNNING_NUMBER_FROM_RBC_ENCODER_H_INCLUDED
