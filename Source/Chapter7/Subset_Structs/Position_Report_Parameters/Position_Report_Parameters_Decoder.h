...
#ifndef POSITION_REPORT_PARAMETERS_DECODER_H_INCLUDED
#define POSITION_REPORT_PARAMETERS_DECODER_H_INCLUDED
...
#endif // POSITION_REPORT_PARAMETERS_DECODER_H_INCLUDED
