...
#ifndef TEMPORARY_SPEED_RESTRICTION_REVOCATION_DECODER_H_INCLUDED
#define TEMPORARY_SPEED_RESTRICTION_REVOCATION_DECODER_H_INCLUDED
...
#endif // TEMPORARY_SPEED_RESTRICTION_REVOCATION_DECODER_H_INCLUDED
