...
#ifndef REPOSITIONING_INFORMATION_DECODER_H_INCLUDED
#define REPOSITIONING_INFORMATION_DECODER_H_INCLUDED
...
#endif // REPOSITIONING_INFORMATION_DECODER_H_INCLUDED
