...
#ifndef ONBOARD_TELEPHONE_NUMBERS_ENCODER_H_INCLUDED
#define ONBOARD_TELEPHONE_NUMBERS_ENCODER_H_INCLUDED
...
#endif // ONBOARD_TELEPHONE_NUMBERS_ENCODER_H_INCLUDED
