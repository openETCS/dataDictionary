...
#include "Session_Management_with_neighbouring_Radio_Infill_Unit_Data_Encoder.h"
#include "Session_Management_with_neighbouring_Radio_Infill_Unit_Data_UpperBitsNotSet.h"
...
int Session_Management_with_neighbouring_Radio_Infill_Unit_Data_Encoder(Bitstream* stream, const Session_Management_with_neighbouring_Radio_Infill_Unit_Data* p)
{
    ...
    {
        if (Session_Management_with_neighbouring_Radio_Infill_Unit_Data_UpperBitsNotSet(p))
        {
