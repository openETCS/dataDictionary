...
#ifndef TRACK_CONDITION_BIG_METAL_MASSES_DECODER_H_INCLUDED
#define TRACK_CONDITION_BIG_METAL_MASSES_DECODER_H_INCLUDED
...
#endif // TRACK_CONDITION_BIG_METAL_MASSES_DECODER_H_INCLUDED
