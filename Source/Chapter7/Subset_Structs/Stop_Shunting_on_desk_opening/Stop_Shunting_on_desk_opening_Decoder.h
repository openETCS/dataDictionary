...
#ifndef STOP_SHUNTING_ON_DESK_OPENING_DECODER_H_INCLUDED
#define STOP_SHUNTING_ON_DESK_OPENING_DECODER_H_INCLUDED
...
#endif // STOP_SHUNTING_ON_DESK_OPENING_DECODER_H_INCLUDED
