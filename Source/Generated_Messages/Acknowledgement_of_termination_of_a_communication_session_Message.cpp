...
bool Acknowledgement_of_termination_of_a_communication_session_Message::decode(Bitstream& stream)
{
...
bool Acknowledgement_of_termination_of_a_communication_session_Message::encode(Bitstream& stream) const
{
    uint32_t old_pos = stream.bitpos;
